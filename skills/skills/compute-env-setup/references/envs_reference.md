...
description: The Operon compute environments as worked examples of the generalized build-spec pattern. Read alongside compute-env-setup. Triggers on "what's in proteomics-gpu", "which env has X", "rebuild <env>", "weight cache for <tool>".
---
