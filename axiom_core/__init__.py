"""axiom-core: Axiom 的 Python 后端。

公开 API:
    from axiom_core import Settings, OpenAICompatClient
    from axiom_core.llm import Message, TextBlock, ToolUseBlock, ToolDefinition
