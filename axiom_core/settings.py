...
- 与 axiom_core.config.Settings 的双向转换, 保证后端其它模块仍使用原有配置体系
"""
...
class AppSettings(BaseModel):
    ...
    # 审稿 / 收敛审查配置 (对应 axiom_core.config.VerificationConfig)
    verification: VerificationConfig = Field(default_factory=VerificationConfig)
    # 结构化 trace 配置 (对应 axiom_core.config.TraceConfig)
...
# ---- 与 axiom_core.config.Settings 的转换 ----
