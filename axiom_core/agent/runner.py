...
from axiom_core.prompts.registry import build_system_prompt
...
class Agent:
    ...
    def __init__(
        ...
        *,
        ...
        from axiom_core.compact.state import new_rolling_compact_state
    ...
    def _handle_overflow(self) -> None:
        ...
        from axiom_core.compact.engine import note_overflow
    ...
    async def _recall_memory(self, user_input: str) -> None:
        ...
        try:
            ...
            from axiom_core.memory.recall import recall, render_recall_block
    ...
    async def _extract_memories_background(self) -> None:
        ...
        try:
            from axiom_core.config import load_settings
            from axiom_core.memory.extract import apply_extraction, extract_memories
    ...
    def _prepare_messages_for_llm(self) -> list[Message]:
        ...
        from axiom_core.compact.projection import prepare_messages_for_llm
    ...
    def _init_verifier(self) -> None:
        ...
        if self._verifier is not None:
            return
        from axiom_core.config import VerificationConfig as SettingsVerificationConfig
        from axiom_core.config import load_settings
        from axiom_core.verify.verifier import VerificationConfig as VerifierConfig
        from axiom_core.verify.verifier import Verifier
        ...
        # axiom_core.config.VerificationConfig (Pydantic settings) 与
        # axiom_core.verify.verifier.VerificationConfig (dataclass) 字段不同, 不能直接混用。
