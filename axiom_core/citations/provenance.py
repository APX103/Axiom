...
形成可复现的 lineage 图。环境开关 AXIOM_PROVENANCE_OFF=1 可关。
...
def provenance_enabled() -> bool:
    """是否启用 provenance。对照原版 AXIOM_PROVENANCE_OFF 环境开关。"""
    return os.environ.get("AXIOM_PROVENANCE_OFF", "0") != "1"
...
def auto_extract_lineage(code: str, artifact_store: Any | None = None) -> dict[str, Any]:
    ...
    """
    from axiom_core.artifacts.store import extract_markers  # 延迟导入
