...
from axiom_core.skills.parser import Skill  # 仅用于构造索引对象
from axiom_core.skills.search import SearchResult, SkillIndex  # 复用 BM25
...
def register_mcp_search_tools(registry: ToolRegistry, manager: MCPServerManager) -> int:
    ...
    返回 2 (固定)。
    工具列表缓存在闭包里, 用 axiom_core.skills.search 的 BM25 索引检索。
    """
