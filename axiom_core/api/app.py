...
def create_app() -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            from axiom_core.observability import setup_logging
            from axiom_core.observability.trace import cleanup_old_traces
    ...
    app = FastAPI(title="axiom-core API", version=axiom_core.__version__, lifespan=lifespan)
    ...
    async def health() -> dict[str, str]:
        return {"status": "ok", "version": axiom_core.__version__}
    ...
    async def list_templates() -> list[dict[str, Any]]:
        ...
        """
        from axiom_core.templates import list_templates as _list_templates
    ...
    async def get_template(template_id: str) -> dict[str, Any]:
        ...
        from axiom_core.templates import get_template_path
    ...
    # ---- 项目 CRUD (Layer A.5) ----
    from axiom_core.db.session import DEFAULT_PROJECT_ID
    ...
    async def create_project(req: CreateProject) -> dict[str, Any]:
        ...
        from axiom_core.db.schema import Project
    ...
    async def compile_session(sid: str, req: CompileReq) -> dict[str, Any]:
        ...
        if ws is None:
            raise HTTPException(404, "session not found")
        from axiom_core.tools.builtins.latex import compile_tex
